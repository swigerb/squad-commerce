...
<!-- squad:capabilities schema=1 specialists=5 taskTypes=5 hints=0 -->
...
| --- | --- | --- | --- |
| Bill Gates | Lead | review | Architecture, scope management, code review, system-level thinking |
| Satya Nadella | Lead Dev | advisory | Microsoft Agent Framework (MAF), A2A protocol, MCP servers, ASP.NET Core backend, agent orchestrati… |
| Anders | Backend Dev | advisory | ASP.NET Core, SignalR, C# language patterns, middleware, dependency injection, real-time communicat… |
| Clippy | User Advocate / AG-UI Expert | advisory | AG-UI protocol, A2UI Blazor components, Blazor frontend, UX design, SignalR real-time UI, accessibi… |
| Steve Ballmer | Tester | review | Unit testing, integration testing, edge cases, quality assurance, xUnit, test automation |

### Supported task types

Lead, Lead Dev, Backend Dev, User Advocate / AG-UI Expert, Tester
...
- **Can:** review code and pull requests; write and run tests; author and maintain CI/CD workflows; UX and visual design
- **Cannot (no agent claims this):** write and modify code; write and maintain documentation; security and secrets review; responsible-AI and content-safety review; cut releases and publish packages; deploy to live environments
